...
<div class="container">
    ...
    <div class="card card-header-mvp">
        <h1><img src="img/logo.svg" class="h1-logo" alt=""> Ragnarok MVP Timer</h1>
        ...
        <div id="listaMonitoramento" class="lista-monitoramento">
            ...
            <div class="mvp-ativo" id="ativo-<?= $a['id'] ?>"
                ...
                <div class="mvp-timer" id="timer-<?= $a['id'] ?>">
                    <?php if ($a['spawn_est']): ?>--:--<?php else: ?><svg class="ico-mini" viewBox="0 0 24 24" fill="currentColor" stroke="none"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg><?php endif; ?>
                </div>

                <button class="btn-finalizar" onclick="finalizarMonitor(<?= $a['id'] ?>)" title="Remover"><svg class="ico-mini" viewBox="0 0 24 24"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<div id="modalMorte" class="modal-overlay" style="display:none;">
    <div class="modal-box">
        <div class="modal-header">
            ...
            <button class="modal-close" onclick="fecharModal()"><svg class="ico-mini" viewBox="0 0 24 24"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button>
        </div>
        ...
        <div class="modal-acoes">
            <button class="btn-primary btn-block" id="btnConfirmarModal" onclick="confirmarMonitor()">
                <svg class="btn-ico" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="14.5 17.5 3 6 3 3 6 3 17.5 14.5"/><line x1="13" y1="19" x2="19" y2="13"/><line x1="16" y1="16" x2="20" y2="20"/><line x1="19" y1="21" x2="21" y2="19"/></svg>
