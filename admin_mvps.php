...
// ── Constante para montar URL da imagem ──────────────────────────
...
// ── Processar POST (salvar novo / editar) ────────────────────────
...
if ($acao === 'deletar' && $id) {
    // Só exclui se não houver monitoramentos vinculados
...
// Rola até o formulário ao clicar em editar
<?php if ($editando): ?>
